...
namespace Sheenazien8\BluetoothDevices\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for BluetoothDevices plugin.
 *
...
{
    protected $signature = 'nativephp:bluetooth-devices:copy-assets';

    protected $description = 'Copy assets for BluetoothDevices plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for BluetoothDevices');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for BluetoothDevices');
    }
}